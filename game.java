...
public class game extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 3.png"))); // NOI18N
        dashboardPage.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        dashboardPage.add(daftar, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 480, 130, 50));
        ...
        dashboardPage.add(masuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 480, 120, 50));
        ...
        dashboardPage.add(exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 560, 130, 50));

        container.add(dashboardPage, "dashboardPage");

        signupPage.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pwSign.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        pwSign.setForeground(new java.awt.Color(178, 178, 177));
        pwSign.setText("Masukkan Password Kamu");
        signupPage.add(pwSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 420, 380, 50));

        noTelpSign.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        noTelpSign.setForeground(new java.awt.Color(178, 178, 177));
        noTelpSign.setText("Masukkan Nomor Telepon Kamu");
        signupPage.add(noTelpSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 360, 400, -1));

        emailSign.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        emailSign.setForeground(new java.awt.Color(178, 178, 177));
        emailSign.setText("Masukkan Email Kamu");
        signupPage.add(emailSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 280, 400, 50));

        userSign.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        userSign.setForeground(new java.awt.Color(178, 178, 177));
        userSign.setText("Masukkan Username Kamu");
        signupPage.add(userSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 210, 390, 50));

        txtUsername.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        signupPage.add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 214, 390, 40));

        txtEmail.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        signupPage.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 290, 390, 30));

        txtNoTelp.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        signupPage.add(txtNoTelp, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 362, 400, -1));

        txtPassSU.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        signupPage.add(txtPassSU, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 430, 390, 40));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 7.png"))); // NOI18N
        signupPage.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        signupPage.add(daftarAkun, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 490, 120, 50));
        ...
        signupPage.add(punyaAkun, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 550, 320, 30));
        ...
        signupPage.add(pengunjungDaftar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 600, 410, 50));

        container.add(signupPage, "signupPage");

        loginPage.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pwLog.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        pwLog.setForeground(new java.awt.Color(178, 178, 177));
        pwLog.setText("Masukkan Password Kamu");
        loginPage.add(pwLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 390, 300, 60));

        emailLog.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        emailLog.setForeground(new java.awt.Color(178, 178, 177));
        emailLog.setText("Masukkan Email Kamu");
        loginPage.add(emailLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 270, 70));

        txtEmailLog.setBackground(new java.awt.Color(243, 248, 251));
        txtEmailLog.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        loginPage.add(txtEmailLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 330, 370, 40));

        txtPassLog.setBackground(new java.awt.Color(243, 248, 251));
        txtPassLog.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        loginPage.add(txtPassLog, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 400, 370, 40));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 6.png"))); // NOI18N
        loginPage.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        loginPage.add(mainMasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 470, 130, 50));
        ...
        loginPage.add(kembaliMasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 470, 130, 50));
        ...
        loginPage.add(pengunjungMasuk, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 540, 390, 50));
        ...
        homePage.add(txtAkun, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 150, 60));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 8.png"))); // NOI18N
        homePage.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        homePage.add(keluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 670, 230, 60));
        ...
        homePage.add(mulaiGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 380, 230, 160));
        ...
        homePage.add(score, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 580, 190, 60));
        ...
        homePage.add(akun, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 580, 180, 60));

        container.add(homePage, "homePage");

        gamePage.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        salah.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 12.png"))); // NOI18N
        gamePage.add(salah, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 90, 30, 30));

        benar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 13.png"))); // NOI18N
        gamePage.add(benar, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 90, 30, 30));

        skor.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        skor.setText("0");
        gamePage.add(skor, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 90, 90, 40));

        kata.setFont(new java.awt.Font("Poppins", 1, 24)); // NOI18N
        kata.setForeground(new java.awt.Color(121, 64, 2));
        kata.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gamePage.add(kata, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, 210, 70));

        timer_txt.setFont(new java.awt.Font("Poppins", 1, 100)); // NOI18N
        timer_txt.setForeground(new java.awt.Color(121, 64, 2));
        timer_txt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        gamePage.add(timer_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 480, 170, 130));
        ...
        gamePage.add(ans, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 410, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 9.png"))); // NOI18N
        gamePage.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        gamePage.add(repeat, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 90, 90));
        ...
        gamePage.add(submit, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 680, 970, 50));
        ...
        gamePage.add(StartGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 90, 90));
        ...
        scorePage.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 630, 360));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 10.png"))); // NOI18N
        scorePage.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        scorePage.add(scoreKembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 620, 140, 50));

        container.add(scorePage, "scorePage");

        accountPage.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        pwAcc.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        accountPage.add(pwAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 520, 460, 50));

        noTelpAcc.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        accountPage.add(noTelpAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 410, 460, 60));

        emailAcc.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        accountPage.add(emailAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 310, 450, 50));

        userAcc.setFont(new java.awt.Font("Poppins", 0, 24)); // NOI18N
        ...
        accountPage.add(userAcc, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 460, 60));
        ...
        accountPage.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, 380, 440));
        ...
        akunUsername.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                akunUsernameActionPerformed(evt);
            }
        });
        accountPage.add(akunUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 430, -1));
        ...
        accountPage.add(akunEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 313, 440, -1));
        ...
        accountPage.add(akunNoTelp, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 417, 440, 50));
        ...
        accountPage.add(akunPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 520, 440, 50));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Project/Asset 4.png"))); // NOI18N
        accountPage.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 760));
        ...
        accountPage.add(akunUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 620, 130, 50));
        ...
        accountPage.add(akunHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 620, 130, 50));
        ...
        accountPage.add(accountKembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 80, 60));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(container, javax.swing.GroupLayout.PREFERRED_SIZE, 1069, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(container, javax.swing.GroupLayout.PREFERRED_SIZE, 760, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        if (username.isEmpty()) {
            ...
            try {
                ...
                if (rs.next() && rs.getInt(1) > 0) {
                    ...
                    String newPlayer = "INSERT INTO players(player_email, player_username) VALUES (?, ?)";
                    ...
                    pst1 = conn.prepareStatement(newPlayer);
    ...
    private void akunHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_akunHapusActionPerformed
        ...
        try {
            ...
            String dropTempTable = "DROP TABLE temp_admin";
    ...
    private void akunUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_akunUpdateActionPerformed
        ...
        try {
            sql = "UPDATE admin SET acc_email = ?,  acc_username = ?, acc_no_telp = ?, acc_password = ? WHERE acc_email = ?";
            conn = config.configDB();
            pst = conn.prepareStatement(sql);
    ...
    private void akunUsernameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_akunUsernameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_akunUsernameActionPerformed
    ...
    private static String kataAcak() {
        String []arr = {"Aku", "Kamu", "Cinta", "Tapi", "Kau", "Tidak", "Mencintai", "Ku"};
